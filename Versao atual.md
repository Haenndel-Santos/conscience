...
Esse capítulo também corrige uma vulnerabilidade anterior: integração não é o mesmo que hipersincronia. Integração consciente é integração **diferenciada**, isto é, coordenação entre subsistemas sem colapso da diversidade funcional. Crises epilépticas generalizadas e sincronizações patológicas mostram justamente que colapso integrativo pode diminuir consciência, não aumentá-la.
