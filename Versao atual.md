...
*Nota: as referências 1–19 foram verificadas contra PubMed/Crossref/página do periódico em 2026-08-05; as referências 26–30 foram verificadas contra PubMed/Crossref/página do periódico em 2026-08-05; as referências 31–32 foram verificadas contra PubMed/Crossref em 2026-08-07 (ver `CHECKLIST_pendencias.md`, Blocos L e N). A camada social S(t) (Cap. 9) tem hoje um proxy operacional mínimo simulado (V4) e um teste comportamental não-circular do mecanismo de ratificação (V5); o índice 𝒞_hum(t) continua sendo apenas esquemático. A maior parte dos resultados numéricos apresentados neste manuscrito é de simulação sintética de prova de conceito, não validação empírica — as exceções são os recomputes com dados reais de EEG (sono e anestesia, Cap. 11), identificados como tal no próprio texto.*
